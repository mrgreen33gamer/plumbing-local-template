...
// ClearFlow Plumbing — Contact Page (unique build, not just a form import)
...
// ── Service options ────────────────────────────────────────────────────────────
const SERVICES = [
  'Emergency Plumbing', 'Water Heater', 'Fixture Installation',
  'Drain Cleaning', 'Leak Detection', 'Sewer Line Repair',
...
const faq = [
  {
    ...
    answer: "Call us directly at (254) 732-9100. We answer 7 days a week including evenings. For a genuine plumbing emergency in Central Texas, call — don't wait on a form response.",
  },
  {
  ...
  {
    question: 'Do you work on commercial plumbing systems?',
    answer: 'Yes — light commercial plumbing for restaurants, offices, retail spaces, and small warehouses is within our scope. Call to discuss your specific system and location.',
  },
  {
  ...
  },
  {
    ...
    answer: "Our tech will tell you honestly after the diagnosis. If the repair cost exceeds 50% of a new water heater's cost and your unit is over 10 years old, we'll recommend replacement — but we'll always show you the numbers and let you decide.",
  },
];
  ...
  return (
    <main className={styles.page}>
        ...
        <div className={styles.mainInner}>
          ...
          <div className={styles.leftCol}>
            ...
            <div className={styles.infoCards}>
              {[
                ...
                },
                {
                  ...
                  label:     'Email',
                  value:     'hello@clearflowplumbingtx.com',
                  href:      'mailto:hello@clearflowplumbingtx.com',
                ...
                },
                {
                  ...
                  href:      'https://maps.google.com/?q=1401+Franklin+Ave+Waco+TX+76701',
            ...
            <div className={styles.trustBlock}>
              <p className={styles.trustHeading}>Why homeowners choose ClearFlow</p>
              {[
                'Flat-rate pricing — written quote before we start',
                '1-year parts & labor warranty on every repair',
                'TSBPE-licensed Master Plumbers only',
              ...
              {submitted ? (
                <motion.div key="success" className={styles.successCard}
                  ...
                  <p className={styles.successText}>
                    A licensed ClearFlow plumber will reach out shortly — usually within one business day. For urgent needs, call us at{' '}
                    <a href="tel:+12547329100">(254) 732-9100</a>.
                  </p>
      ...
      <CTABanner
        ...
        subline="Call (254) 732-9100 — we answer 7 days a week, evenings included. Emergency service available across Central Texas."
        primaryText="Call (254) 732-9100"
        primaryLink="tel:+12547329100"
        secondaryText="Send a Text"
        secondaryLink="sms:+12547329100"
      />
