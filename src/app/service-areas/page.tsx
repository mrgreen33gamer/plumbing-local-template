...
// ClearFlow Plumbing — Service Areas Page
'use client';
...
const SERVICE_AREAS = [
  {
    ...
    badge:       'Home Base',
    description: 'Our headquarters. Fastest response times, same-day service available 7 days a week. Full plumbing repair, emergency plumbing, water heaters, drains, leaks, and sewer lines across all of Waco.',
  ...
  },
  {
    ...
    county:      'McLennan County',
    badge:       'Primary Area',
    description: 'Full plumbing coverage for Hewitt homes and businesses. Fast dispatch from our Waco base — typically under 45 minutes.',
    highlights:  ['45-min dispatch', 'Residential & commercial', 'Water heaters'],
  },
  {
    city:        'Woodway',
    slug:        'woodway-tx',
    county:      'McLennan County',
    badge:       'Primary Area',
    description: "Serving Woodway's residential neighborhoods with the same flat-rate pricing and 1-Year Workmanship Warranty as every other area we cover.",
    highlights:  ['Flat-rate pricing', '1-Year Workmanship Warranty', 'TSBPE-licensed'],
  },
  {
    city:        'Bellmead',
    slug:        'bellmead-tx',
    county:      'McLennan County',
    badge:       '',
    description: 'Reliable plumbing service for Bellmead residents and businesses. Water heaters, drain cleaning, and fixture installs — same-day when available.',
    highlights:  ['Residential & commercial', 'Licensed Master Plumbers', 'No contracts'],
  },
  {
    city:        'China Spring',
    ...
    county:      'McLennan County',
    badge:       '',
    description: 'Rural and residential plumbing service for the China Spring area. We make the drive — flat-rate pricing applies just the same.',
  ...
  },
  {
    ...
    county:      'McLennan County',
    badge:       '',
    description: 'Plumbing repair, water heaters, and drain service for McGregor homes and light industrial properties.',
    highlights:  ['Residential & light commercial', 'Water heaters', 'Same-day when available'],
  },
  {
    city:        'Killeen',
    slug:        'killeen-tx',
    county:      'Bell County',
    badge:       '',
    description: 'Plumbing repair, installation, and emergency service for Killeen and Fort Cavazos area homes and businesses. Military-friendly scheduling.',
  ...
  },
  {
    ...
    county:      'Bell County',
    badge:       '',
    description: 'Full-service plumbing coverage for Temple. Medical district and surrounding neighborhoods served. Full residential and commercial plumbing.',
...
const faq = [
  ...
  {
    question: 'Do you work on commercial plumbing in all areas?',
    answer: 'Yes — light commercial plumbing for restaurants, offices, retail spaces, and small warehouses is within scope across all our coverage areas. Call to discuss your specific project and location.',
  },
  {
    ...
    <main className={styles.page}>
        ...
        <div className={styles.heroInner}>
          ...
          >
            <div className={styles.heroBadge}>
              ...
              Central Texas Plumbing — Since 2009
            </div>
            ...
            <p className={styles.heroSub}>
              Based in Waco, serving all of Central Texas. Flat-rate pricing, Licensed Master Plumbers, and a 1-Year Workmanship Warranty — no matter where you are.
            </p>
            <div className={styles.heroActions}>
              <a href="tel:+12547329100" className={styles.heroCTAPrimary}>
          ...
          <motion.div className={styles.trustStrip}
            ...
            {[
              ...
              { val: '1-Year', lbl: 'Workmanship Warranty' },
            ].map(({ val, lbl }) => (
        ...
        <div className={styles.areasSectionInner}>
          <div className={styles.sectionHeader}>
            ...
            <p className={styles.sectionSub}>
              Click any city to see local service details, common plumbing issues in your area, and what to expect from our team.
            </p>
          </div>
              ...
              return (
                ...
                >
                  ...
                  <div className={styles.areaFooter}>
                    <a href="tel:+12547329100" className={styles.areaCallBtn}>
      ...
      <section className={styles.unlisted}>
        <div className={styles.unlistedInner}>
          ...
          <a href="tel:+12547329100" className={styles.unlistedCTA}>
            Call (254) 732-9100
          </a>
        </div>
      </section>
      ...
      <CTABanner
        ...
        subline="Same-day service available across Central Texas. Flat-rate pricing, 1-Year Workmanship Warranty, no contracts ever."
