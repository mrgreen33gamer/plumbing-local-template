...
export default function IndustryPage() {
  ...
  return (
    <main className={styles.pageWrapper}>
      ...
      <SectionIntro title="Plumbing Services for Property Management Companies" subtitle="Multi-unit make-ready, CapEx water heater swaps, and reliable tenant-ticket response — TSBPE-licensed, portfolio-ready." />
      ...
      <div className={styles.section}><LocalServiceAreas cityName="Waco" areas={localAreas} servicePath="industries/property-management" title="Commercial Coverage Across Central Texas" /></div>
      ...
      <div className={styles.section}><Variant4 title="Talk to Us About Your Properties" cityName="Waco" slug="industries/property-management" spot="property-management-industry-form" formVariant={2} /></div>
    </main>
  );
}
