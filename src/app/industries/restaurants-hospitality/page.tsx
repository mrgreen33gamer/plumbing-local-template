...
export default function IndustryPage() {
  ...
  return (
    <main className={styles.pageWrapper}>
      ...
      <SectionIntro title="Plumbing for Restaurants & Hospitality" subtitle="Grease lines, commercial fixtures, after-hours repairs — keep kitchens open and inspections clean." />
      <TrustBar headline="Trusted by Central Texas property and commercial operators for reliable plumbing" />
      <div className={styles.section}><IndustryPainPoints industry="restaurants & hospitality" painPoints={painPoints} /></div>
      ...
      <div className={styles.section}><LocalServiceAreas cityName="Waco" areas={localAreas} servicePath="industries/restaurants-hospitality" title="Commercial Coverage Across Central Texas" /></div>
      ...
      <div className={styles.section}><Variant4 title="Talk to Us About Your Properties" cityName="Waco" slug="industries/restaurants-hospitality" spot="restaurants-hospitality-industry-form" formVariant={2} /></div>
    </main>
  );
}
