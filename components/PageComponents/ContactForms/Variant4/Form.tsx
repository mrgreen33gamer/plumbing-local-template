...
import {
  ...
  faDroplet, faFire, faWrench, faSink, faSearch, faToilet, faBolt,
...
const SERVICES = [
  { icon: faBolt,    label: 'Emergency Plumbing',   sub: 'Burst pipe, no water, flooding' },
  { icon: faFire,    label: 'Water Heater',         sub: 'No hot water, replace or repair' },
  { icon: faWrench,  label: 'Fixture Installation', sub: 'Sinks, toilets, faucets, disposals' },
  { icon: faSink,    label: 'Drain Cleaning',       sub: 'Slow drains, clogs, backups' },
  { icon: faSearch,  label: 'Leak Detection',       sub: 'Slab leaks, hidden moisture' },
  { icon: faToilet,  label: 'Sewer Line',           sub: 'Main line issues, camera inspect' },
  { icon: faDroplet, label: 'Other Plumbing',       sub: 'General repair or question' },
];
              ...
              {submitted ? (
                <motion.div key="success" className={styles.successState}
                  ...
                  <p className={styles.successText}>
                    A ClearFlow plumber will reach out about your <strong>{selectedService}</strong> service.
                  </p>
