...
const SERVICES: Service[] = [
  { icon: faGlobe,         label: 'Emergency Plumbing' },
  { icon: faCodeBranch,    label: 'Water Heater' },
  { icon: faImagePortrait, label: 'Fixture Installation' },
  { icon: faBullhorn,      label: 'Drain Cleaning' },
  { icon: faRobot,         label: 'Leak Detection' },
  { icon: faCubesStacked,  label: 'Sewer Line Repair' },
];

export default function RequestServiceCTA({
  headline = "Ready for Reliable Plumbing?",
  subline  = "Pick the services you need — we'll put together a flat-rate quote for your home or property.",
