...
import {
  ...
  faDroplet, faFire, faWrench, faSink, faSearch,
  faToilet, faBolt,
        ...
        <div className={styles.card}>
          ...
          <div className={styles.leftPanel}>
            <div className={styles.panelInner}>
              ...
              <span className={styles.quoteAttrib}>— ClearFlow Plumbing, Waco TX</span>

              <div className={styles.panelStats}>
                {[
                  { val: '8,000+', lbl: 'Jobs Completed' },
                  { val: '4.9★',   lbl: 'Google Rating' },
                  { val: '17+',    lbl: 'Years Local' },
                ].map(s => (
              ...
              <div className={styles.panelBadges}>
                {['Same-Day Available', '1-Year Warranty', 'No Contracts', 'TSBPE Licensed'].map(b => (
