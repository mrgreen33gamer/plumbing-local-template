...
const SERVICES = [
  { icon: faBolt,    label: 'Emergency Plumbing' },
  { icon: faFire,    label: 'Water Heater' },
  { icon: faWrench,  label: 'Fixture Installation' },
  { icon: faSink,    label: 'Drain Cleaning' },
  { icon: faSearch,  label: 'Leak Detection' },
  { icon: faToilet,  label: 'Sewer Line' },
  { icon: faDroplet, label: 'Other Plumbing' },
];
...
const TRUST_CHIPS = [
  ...
  { icon: faShieldHalved, text: 'TSBPE · Master Plumber' },
  { icon: faStar,         text: '4.9★ · 680+ reviews' },
];
            ...
            {submitted ? (
              <motion.div key="success" className={styles.successState}
                ...
                <p className={styles.successText}>
                  A ClearFlow plumber will reach out shortly. Keep an eye on your inbox and phone.
                </p>
                ...
                <form className={styles.form} onSubmit={handleSubmit} noValidate>
                  ...
                  <div className={styles.submitRow}>
                    ...
                    <div className={styles.altContact}>
                      ...
                      <span>Need help now?{' '}
                        <a href="tel:+12547329100"
                          onClick={() => trackEvent({ eventType: 'phone_click', elementLabel: 'Call (254) 732-9100', section: 'ContactForm-V1' })}>
                          Call (254) 732-9100
                        </a>
                      </span>
                    </div>
