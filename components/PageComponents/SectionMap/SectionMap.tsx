  ...
  const initMap = () => {
    ...
    currentMap.on('load', () => {
      ...
      new mapboxgl.Marker({ element: hqEl, anchor: 'center' })
        ...
        .setPopup(new mapboxgl.Popup().setHTML('<strong>ClearFlow Plumbing HQ</strong><br>1401 Franklin Ave, Waco, TX 76701'))
        .addTo(currentMap);
  ...
  return (
    <section ref={sectionRef} className={styles.mapSection}>
      ...
      <div className={styles.mapLegend}>
        <div><span className={styles.hqDot} /> ClearFlow Plumbing HQ – Waco</div>
