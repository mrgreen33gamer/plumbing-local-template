...
const DEFAULT_GUARANTEES: Guarantee[] = [
  ...
  },
  {
    ...
    description:
      "Every installation we perform is covered for one full year of workmanship. If our work fails within 12 months, we make it right at no charge.",
  },
  {
    icon: faRotateLeft,
  ...
  {
    icon: faCertificate,
    title: "Licensed Master Plumbers · TSBPE",
    description:
      "Every plumber who enters your home is TSBPE-licensed. No unlicensed subs working alone — ever.",
  },
  {
      ...
      <div className={styles.container}>
        ...
        <div className={styles.leftCol}>
          ...
          <p className={styles.body}>
            Every plumbing company in Central Texas makes promises. We back ours in writing — with flat-rate pricing, TSBPE-licensed plumbers, and a 1-Year Workmanship Warranty on every install we touch.
          </p>
          <Link
            href={ctaLink}
          ...
          <div className={styles.ratingRow}>
            ...
            <span className={styles.ratingText}>4.9 · 680+ verified Google reviews</span>
          </div>
        </div>
