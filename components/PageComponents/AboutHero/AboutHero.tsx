      ...
      <div className={styles.heroContainer}>
        ...
        >
          ...
          <h1 className={styles.heroTitle}>
            Central Texas Plumbing<br />
            <em>Done Right.</em><br />
            Every Time.
          </h1>
          <p className={styles.heroSubtitle}>
            ClearFlow Plumbing has been keeping homes and businesses comfortable in{' '}
          ...
          <div className={styles.imageFrame}>
            <div className={styles.imageWrapper}>
              <Image
                ...
                alt="ClearFlow Plumbing — Waco, Texas plumbers"
                fill
            ...
            <div className={styles.trustCard}>
              ...
              <div className={styles.trustCardText}>
                <span className={styles.trustCardTitle}>ClearFlow Plumbing</span>
                <span className={styles.trustCardSub}>Waco's Most Trusted Plumber</span>
              </div>
            </div>
          </div>
        </motion.div>
