...
const LocalCitationBlock: React.FC<LocalCitationBlockProps> = ({
  ...
  googleMapsUrl = 'https://maps.google.com/?q=ClearFlow+Plumbing+Waco+TX',
  hours         = DEFAULT_HOURS,
  cityName      = 'Waco',
}) => {
  return (
    <section
      ...
      itemScope
      itemType="https://schema.org/Plumber"
    >
      <div className={styles.container}>
        ...
        <div className={styles.header}>
          ...
          <p className={styles.subtitle}>
            Based in {cityName}, TX — serving all of Central Texas with licensed plumbers.
          </p>
        </div>
