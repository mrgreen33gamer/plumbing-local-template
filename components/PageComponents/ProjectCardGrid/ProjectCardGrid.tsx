...
const SERVICE_CTAS = [
  {
    ...
    headline: 'Burst pipe or active backup?',
    body: 'Same-day emergency response across Central Texas. Flat-rate pricing, Licensed Master Plumber.',
  ...
  },
  {
    ...
    headline: 'No hot water at home?',
    body: 'Tank and tankless repair or full replacement — flat-rate install quotes before we start.',
    cta: 'Get a Water Heater Quote',
    href: '/services/water-heater-repair-install',
  ...
  },
  {
    ...
    headline: 'Slow drains or recurring clogs?',
    body: 'Snaking and hydro-jetting for fixtures and main lines. Same-day options available.',
    cta: 'Schedule Drain Cleaning',
  ...
  },
  {
    ...
    headline: 'Need a commercial plumbing partner?',
    body: 'Property managers, restaurants, and multi-family — COIs available, after-hours friendly.',
...
function fileToAlt(filename: string): string {
  ...
  return `${words} — ClearFlow Plumbing Portfolio`;
}
