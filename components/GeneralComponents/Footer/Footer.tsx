...
import {
  ...
  faShieldHalved, faWrench, faClock, faDroplet,
...
const SERVICE_LINKS = [
  ...
  { href: '/services/water-heater-repair-install', label: 'Water Heaters' },
  { href: '/services/fixture-installation',      label: 'Fixture Installation' },
  { href: '/services/drain-cleaning',            label: 'Drain Cleaning' },
  { href: '/services/leak-detection-repair',     label: 'Leak Detection' },
...
const TRUST_ITEMS = [
  ...
  { icon: faWrench,       label: 'TSBPE Licensed' },
  { icon: faClock,        label: 'Same-Day Service' },
  { icon: faDroplet,    label: '1-Yr Warranty' },
];

const SOCIALS = [
  { href: 'https://facebook.com/clearflowplumbingtx', icon: faFacebookF, label: 'Facebook' },
  { href: 'https://g.page/r/clearflowplumbingtx',     icon: faGoogle,    label: 'Google' },
];
      ...
      <div className={styles.bottomBar}>
        <div className={styles.bottomInner}>
          <p className={styles.copyright}>
            &copy; {new Date().getFullYear()} ClearFlow Plumbing. All Rights Reserved. | TSBPE License #XXXXXXXX
          </p>
          <a href="tel:+12547329100" className={styles.emergencyBtn}
